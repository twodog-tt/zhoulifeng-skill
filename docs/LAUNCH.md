...
This is an automated/static evaluation result, not proof of perfect fidelity.
...
Latest release: `zhoulifeng-skill` v0.8.0.

It is an authorized 峰哥亡命天涯 style Skill for social observation and commentary drafts, with launch materials, source verification workflow, external review intake, hard safety boundaries, and explicit verified / candidate / rejected model separation.

Not a real-time official statement generator. Not a dangerous travel or gray-market guide. Not a transcript archive.

v0.9 external review intake has started. The first recorded reviewer decision is concern, not safety hold; fixes are addressed pending follow-up confirmation.
